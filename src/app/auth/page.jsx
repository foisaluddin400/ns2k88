...
const Page = () => {
  return (
    <div className="relative -mt-20 -mb-20 h-[100vh] w-full">
      {/* Background Image */}
      <Image
        src={backImage}
        alt="Auth Background"
      ...
      <div className="relative z-10 flex flex-col h-full justify-end px-6 pb-10 text-white">
        ...
        <div className="space-y-4">
          ...
          <Link href={'/signIn'}><button className="w-full border mt-4 border-white text-white py-3 rounded-full font-semibold text-lg hover:bg-white/10 transition">
            Login
          </button></Link>
        </div>
      </div>
