...
const Profile = () => {
  ...
  const accountSection = [
    ...
    { title: "Favorite Trainer", route: "/favorite_trainer" },
    { title: "My Trainer", route: "/coach" },
  ];
        ...
        <div className="space-y-2">
          {accountSection.map((item, idx) => (
            <div
              ...
              className="flex justify-between items-center p-3 bg-white rounded-lg cursor-pointer hover:bg-gray-100"
            >
      ...
      <div className="space-y-2">
        {socialLinks.map((link, idx) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center space-x-3 p-3 bg-white rounded-lg hover:bg-gray-200"
          >
